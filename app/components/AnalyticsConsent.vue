<template>
  <div
      aria-live="polite"
      class="fixed inset-x-0 bottom-0 z-40 mx-auto mb-4 w-[min(100%,44rem)] rounded-2xl border border-orange-200/60 bg-white/95 p-4 shadow-lg backdrop-blur"
      role="dialog"
  >
...
defineEmits<{ (e: 'accept'): void; (e: 'decline'): void }>()
</script>
